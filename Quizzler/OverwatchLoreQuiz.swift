...
class OverwatchLoreQuiz{
    ...
    { // Creating a quiz item and appending it to the list
        ...
        list.append(Question(text: "What was Bastions ultimate in beta testing?", correctAnswer: 1, option1: "Flight", option2: "Tank", option3: "Shield", gifName: "Test3"))
        
        list.append(Question(text: "What game was D.Va a professional at?", correctAnswer: 3, option1: "World of Warcraft", option2: "Hearthstone", option3: "Starcraft", gifName: "Test1"))
        
        list.append(Question(text: "From scratch how long until Overwatch was playable?", correctAnswer: 2, option1: "2 months", option2: "5 months", option3: "15 Weeks", gifName: "Test2"))
        
        list.append(Question(text: "What was the name of Pharah in development?", correctAnswer: 3, option1: "Guardian", option2: "Warrior", option3: "Rocket Queen", gifName: "Test3"))
        
        list.append(Question(text: "Overwatch was Blizard's first IP in how many years?", correctAnswer: 3, option1: "7 years", option2: "18 years", option3: "17 years", gifName: "Test1"))
        ...
        list.append(Question(text: "Who is the only character who moves silently?", correctAnswer: 3, option1: "Genji", option2: "Reaper", option3: "Zenyatta", gifName: "Test3"))
        ...
        list.append(Question(text: "One of Hanzo's lines makes a parody of...", correctAnswer: 1, option1: "Pokèmon", option2: "Megaman", option3: "Sonic", gifName: "Test3"))
        ...
        list.append(Question(text: "What hero was a double agent to overwatch?", correctAnswer: 1, option1: "Widowmaker", option2: "Reaper", option3: "Doomfist", gifName: "Test1"))
