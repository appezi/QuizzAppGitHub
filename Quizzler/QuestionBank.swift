...
class QuestionBank{
    ...
    init()
    {
        ...
        list.append(Question(text: "What game was D.Va a professional at?", correctAnswer: 3, option1: "World of Warcraft", option2: "Hearthstone", option3: "Starcraft", gifName: "Test"))
